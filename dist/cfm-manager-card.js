/**
 * CFM Manager Cards Bundle
 *
 * Version: v2.6.3
 * Contains:
 * - CFM Manager Card (Main card with state machine)
 * - CFM Mortality Card (Quick mortality recording)
 *
 * CHANGELOG v2.6.3:
 * - Merged both cards into single file for HACS compatibility
 * - Mortality Card now loads automatically with Manager Card
 */
...
// ============================================================
// CFM MORTALITY CARD (Quick Record)
// ============================================================
